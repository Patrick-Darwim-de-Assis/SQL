...
## Repository Contents
* **[181-Employees-Earning-More-Than-Managers](./181-employees-earning-more-than-managers/solution.sql)**: Deep dive into hierarchical data processing using **Self-Joins**, **Correlated Subqueries**, and analyzing structural logic boundaries (the `LEFT JOIN` conditional trap).
